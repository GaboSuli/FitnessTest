...
function InitializeQuestion(index)
{
    if (index < Questions.length)
    {
        ...
        `
                ...
                <input type="radio" name="Kerdes" id="Kerdes" value="1"><label for="Kerdes">${Questions[index].valasz1}</label><br>
                <input type="radio" name="Kerdes" id="Kerdes" value="2"><label for="Kerdes">${Questions[index].valasz2}</label><br>
                <input type="radio" name="Kerdes" id="Kerdes" value="3"><label for="Kerdes">${Questions[index].valasz3}</label><br>
